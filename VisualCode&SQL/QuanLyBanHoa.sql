...
INSERT [dbo].[HoaDon] ([MaHD], [MaNV], [MaKH], [NgayBan], [TongTien]) VALUES (N'02        ', N'02        ', N'02        ', CAST(N'2022-12-29' AS Date), N'400000  ')
GO

INSERT [dbo].[KhachHang] ([MaKH], [TenKH], [GioiTinh], [DiaChi], [SDT]) VALUES (N'01        ', N'Nguyễn Văn A', N'Nam  ', N'Trà Vinh', 456789123)
INSERT [dbo].[KhachHang] ([MaKH], [TenKH], [GioiTinh], [DiaChi], [SDT]) VALUES (N'02        ', N'Lê Thị B', N'Nam  ', N'Bến Tre', 789123456)
GO

INSERT [dbo].[NhaCungCap] ([MaNCC], [TenNCC]) VALUES (N'1         ', N'vuonhoa1')
INSERT [dbo].[NhaCungCap] ([MaNCC], [TenNCC]) VALUES (N'2         ', N'vuonhoa2')
INSERT [dbo].[NhaCungCap] ([MaNCC], [TenNCC]) VALUES (N'3         ', N'vuonhoa3')
INSERT [dbo].[NhaCungCap] ([MaNCC], [TenNCC]) VALUES (N'4         ', N'vuonhoa4')
GO

INSERT [dbo].[NhanVien] ([MaNV], [TenNV], [NgaySinh], [GioiTinh], [DiaChi], [SDT]) VALUES (N'01        ', N'Lê Trực Tín', CAST(N'2003-06-10' AS Date), N'Nam', N'Trà Vinh', 123456789)
INSERT [dbo].[NhanVien] ([MaNV], [TenNV], [NgaySinh], [GioiTinh], [DiaChi], [SDT]) VALUES (N'02        ', N'Lê Thị Nguyễn Xuyên', CAST(N'2003-01-13' AS Date), N'Nữ', N'Trà Vinh', 123789456)
INSERT [dbo].[NhanVien] ([MaNV], [TenNV], [NgaySinh], [GioiTinh], [DiaChi], [SDT]) VALUES (N'03        ', N'Trần Khánh Duy', CAST(N'2003-01-13' AS Date), N'Nam', N'Trà Vinh', 123789456)
GO

INSERT [dbo].[SanPham] ([MaSP], [MaNCC], [TenSP], [SoLuong], [DonGiaNhap], [DonGiaBan]) VALUES (N'01        ', N'4         ', N'Hoa Lan', 10, 150000, 200000)
INSERT [dbo].[SanPham] ([MaSP], [MaNCC], [TenSP], [SoLuong], [DonGiaNhap], [DonGiaBan]) VALUES (N'02        ', N'1         ', N'Hoa Hồng', 20, 70000, 100000)
INSERT [dbo].[SanPham] ([MaSP], [MaNCC], [TenSP], [SoLuong], [DonGiaNhap], [DonGiaBan]) VALUES (N'03        ', N'3         ', N'Hoa Cúc', 50, 200000, 250000)
INSERT [dbo].[SanPham] ([MaSP], [MaNCC], [TenSP], [SoLuong], [DonGiaNhap], [DonGiaBan]) VALUES (N'04        ', N'2         ', N'Vạn Thọ', 5, 250000, 300000)
GO
